...
public class AddNewUsersReservationPanelController {
    ...
    public class SetData implements Runnable {
        ...
        public class addToDeleteReservation implements Runnable {
 
                private void delete_reservation_from_db(int index) throws Exception {
                        WhatID1 thread1 = new WhatID1();
                ...
                private int index;
                private addToDeleteReservation(int index) {
                        this.index = index;
                }
        ...
        public class WhatID1 implements Callable {
    ...
    private void close() throws IOException{
        ...
        int cout_of_rows = (int) (thread1.call());
                ...
                for (int i = 0;i < cout_of_rows;i++)
                {
                        ...
                        if(Check.isSelected()) {
                                addToDeleteReservation thread5 = new addToDeleteReservation(i);
                                thread5.run();
